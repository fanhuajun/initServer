...
/etc/init.d/zabbix_server stop &> /dev/null
...
killall zabbix_server &> /dev/null
...
echo "/alidata/server/httpd-*           delete ok!"
rm -rf /alidata/server/httpd-*
echo "/alidata/server/nagios			delete ok!"
rm -rf /alidata/server/zabbix
echo "/alidata/server/zabbix-*			delete ok!"
...
echo "/etc/init.d/zabbix_server          delete ok!"
rm -f /etc/init.d/zabbix_server
echo "/etc/init.d/zabbix_agentd          delete ok!"
