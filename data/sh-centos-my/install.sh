...
export zabbix_version=2.4.2
export mirrored_version=1.0
...
echo "vsftp  : $vsftpd_version"
echo "zabbix : $zabbix_version"
echo "mirrored_version : $mirrored_version"
...
####---- zabbix ----begin####
./zabbix/install_zabbix-2.4.2.sh
####---- zabbix ----end####
echo "---------- zabbix ${zabbix_version} ok ----------" >> tmp.log
echo "---------- $mirrored_version ----------" >> tmp.log
####---- log ----begin####
